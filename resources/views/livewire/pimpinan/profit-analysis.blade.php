<div>
    <div
        class="min-h-screen space-y-12 pb-20 font-jakarta transition-colors duration-300 bg-slate-50 dark:bg-[#0a0a0a]">
            ...
            <div class="max-w-8xl mx-auto flex justify-between items-end">
                ...
                <div class="flex items-center gap-6">
                    <div class="hidden md:block text-right">
                        <span class="text-[10px] uppercase font-bold text-slate-400 block mb-1">URUTAN
                            BERDASARKAN:</span>
        ...
        <div class="px-6 max-w-8xl mx-auto space-y-16">
            ...
            'text-emerald-600 dark:text-emerald-400', 'ring' => 'focus:ring-emerald-500', 'icon' => 'bg-emerald-500',
            'btn'
            => 'hover:shadow-emerald-500/30'],
            ['gradient' => 'from-violet-600 via-purple-500 to-fuchsia-500', 'bg_soft' => 'bg-violet-50/50
            dark:bg-violet-500/10', 'border' => 'border-violet-200 dark:border-violet-500/20', 'text' =>
            'text-violet-600
            dark:text-violet-400', 'ring' => 'focus:ring-violet-500', 'icon' => 'bg-violet-500', 'btn' =>
            'hover:shadow-violet-500/30'],
            ['gradient' => 'from-amber-500 via-orange-500 to-red-500', 'bg_soft' => 'bg-amber-50/50
            dark:bg-amber-500/10',
            'border' => 'border-amber-200 dark:border-amber-500/20', 'text' => 'text-amber-600 dark:text-amber-400',
            'ring'
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="relative z-10 flex items-center gap-5">
                            ...
                            <div>
                                <p class="text-[10px] font-bold text-white/80 uppercase tracking-[0.2em] mb-1">WILAYAH
                                </p>
                                <h2
                    ...
                    <div class="p-6 md:p-8 space-y-8">
                                ...
                                <div class="md:col-span-4" x-data="{ 
                                    ...
                                    <div class="relative" @click.outside="open = false">
                                        ...
                                        text-slate-700 dark:text-white">
                                            <span x-show="selected.length === 0" class="text-slate-400">-- Klik untuk
                                                Pilih
                                                --</span>
                                    ...
                                    <thead
                                        ...
                                        <tr>
                                            <th
                                                ...
                                                LAST SUPPLIER</th>
                                            <th class="px-4 py-4 w-64 border-r border-slate-200 dark:border-white/5">
                                                NAME
                                                ITEM</th>
                                            <th
                                            ...
                                            <th
                                                ...
                                                <div
                                                    ...
                                                    <i class="fas fa-mouse-pointer mr-1"></i>Klik Detail
                                                </div>
                                            </th>
                                            <th
                        ...
                        <div
                            ...
                            <div
                                ...
                                <i
                                    class="fas fa-arrow-up text-slate-300 dark:text-slate-600 text-xl animate-bounce"></i>
                            </div>
                            <p class="text-xs text-slate-400 dark:text-slate-600 font-bold uppercase">Pilih Supplier di
                                atas
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="flex items-center gap-2">
                                        <span class="text-[10px] font-bold text-slate-400 uppercase">Diskon
                                            Supplier</span>
                                ...
                                <div class="py-2">
                                    <div class="flex justify-between items-center mb-1">
                                        <span
                                            class="text-[11px] font-black text-amber-600 dark:text-amber-50 uppercase">RAW
                                            HPP (AVG)</span>
                                        <span
                                            class="text-base font-black text-amber-600 dark:text-amber-50 font-mono">Rp
                ...
                <div class="p-6 bg-slate-50 dark:bg-[#151515] border-t border-slate-200 dark:border-white/5">
                    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div class="text-center md:text-left">
                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Harga Jual
                                Final
                                (Fix)</p>
                            <div
