    ...
    <div
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                <div
                    class="p-3 rounded-2xl shadow-lg bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center ring-4 ring-emerald-500/20">
                ...
                <div>
                    <h1 class="text-2xl font-black uppercase leading-none dark:text-white text-slate-800">Manajemen
                        <span class="text-emerald-600 dark:text-emerald-400">Pelunasan</span></h1>
                    <p
                        class="text-[10px] font-bold uppercase tracking-[0.3em] opacity-60 mt-1 dark:text-slate-400 text-slate-500">
                        Integrasi Arus Kas</p>
                </div>
            </div>
            <div class="flex flex-wrap items-center gap-3">
                <button wire:click="openModalImport"
                    class="px-5 py-2.5 bg-white dark:bg-[#1a1a1a] border border-slate-200 dark:border-white/10 rounded-xl flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-white/5 hover:text-emerald-600 transition-all font-black text-[10px] uppercase tracking-widest text-slate-600 dark:text-slate-300 shadow-sm"><i
                        class="fas fa-file-excel text-emerald-500 text-sm"></i> Impor Excel</button>
                <button wire:click="create"
                    class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl flex items-center gap-2 shadow-lg shadow-emerald-500/30 transition-transform active:scale-95 font-black text-[10px] uppercase tracking-widest"><i
            ...
            <div class="p-6 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.02]">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    <div class="md:col-span-4"><label
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"><i
                                ...
                                class="block w-full pl-11 pr-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl leading-5 bg-white dark:bg-[#1a1a1a] text-slate-900 dark:text-white focus:ring-2 focus:ring-emerald-500 text-xs font-bold uppercase tracking-wider shadow-sm transition-all"
                    ...
                    <div class="md:col-span-2"><label
                            ...
                            class="block w-full px-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl bg-white dark:bg-[#1a1a1a] text-slate-700 dark:text-white focus:ring-2 focus:ring-emerald-500 text-xs font-bold uppercase shadow-sm transition-all">
                    ...
                    <div class="md:col-span-2"><button wire:click="resetFilters"
                            class="w-full px-4 py-3 border border-emerald-200 dark:border-emerald-500/30 text-emerald-600 bg-emerald-50 dark:bg-emerald-500/10 hover:bg-emerald-100 dark:hover:bg-emerald-500/20 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-sm"><i
            ...
            <div class="overflow-x-auto custom-scrollbar">
                <table class="w-full text-sm text-left uppercase whitespace-nowrap">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                        ...
                        <tr class="hover:bg-emerald-50 dark:hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="px-6 py-4 text-xs font-black text-right text-emerald-600 dark:text-emerald-400">
                                Rp {{ number_format($item->receive_amount, 0, ',', '.') }}</td>
            ...
            <div class="p-8 overflow-y-auto custom-scrollbar">
                <form wire:submit.prevent="store" class="space-y-6 font-jakarta text-xs uppercase">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div><label
                            ...
                            <div class="relative"><i
                                    ...
                                    class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 pl-10 pr-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-emerald-500 transition-all shadow-sm"
                                    required></div>
                        </div>
                        <div><label
                                ...
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-emerald-500 transition-all shadow-sm"
                                required></div>
                    </div>
                    <div
                        ...
                        <div><label
                                ...
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#121212] px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-emerald-500 transition-all shadow-sm"
                                required>
                        ...
                        <div><label
                            ...
                            <div class="relative"><i
                                    ...
                                    class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#121212] pl-10 pr-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-emerald-500 transition-all shadow-sm"
                                    required></div>
                        </div>
                    </div>
                    <div><label
                    ...
                    <div
                        ...
                        <label
                            class="block text-[10px] font-black text-emerald-700 dark:text-emerald-400 mb-2 tracking-widest">Nominal
                            (Rp) <span class="text-rose-500">*</span></label>
                        <div class="relative flex items-center"><span
                                class="absolute left-4 font-black text-emerald-600 dark:text-emerald-400 text-sm">Rp</span><input
                                type="number" wire:model="nominal"
                                class="w-full rounded-xl border border-emerald-200 dark:border-emerald-500/30 bg-white dark:bg-black/40 pl-12 pr-4 py-4 font-black text-emerald-700 dark:text-emerald-300 focus:ring-2 focus:ring-emerald-500 text-lg shadow-sm transition-all"
                                required></div>
                    </div>
                    <div class="pt-8 flex items-center justify-end gap-3"><button type="submit"
                            class="px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-white bg-emerald-600 hover:bg-emerald-700 shadow-xl shadow-emerald-500/30">Simpan
                            Record</button></div>
                </form>
            </div>
        </div>
