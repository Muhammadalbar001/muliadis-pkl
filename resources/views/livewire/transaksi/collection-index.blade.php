<div class="min-h-screen pb-20 font-jakarta bg-slate-50 dark:bg-[#050505] transition-colors duration-300">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-black uppercase leading-none dark:text-white text-slate-800">
                        Manajemen <span class="text-emerald-600 dark:text-emerald-400">Pelunasan</span>
                    </h1>
                    <p
                        class="text-[10px] font-bold uppercase tracking-[0.3em] opacity-60 mt-1 dark:text-slate-400 text-slate-500">
                        Integrasi Arus Kas & Collection
                    </p>
                </div>
            </div>
            <div class="flex flex-wrap items-center gap-2">
                ...
                <button wire:click="create"
                    class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl flex items-center gap-2 shadow-lg shadow-emerald-500/30 transition-transform active:scale-95 font-black text-[10px] uppercase tracking-widest">
    ...
    <div class="px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div
            class="bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-blue-700 dark:text-blue-400 px-4 py-3 rounded-xl text-sm font-bold flex items-center justify-between shadow-sm animate-fade-in">
        ...
        <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    <div class="md:col-span-4">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model.live.debounce.500ms="search" type="text"
                                class="block w-full pl-11 pr-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl leading-5 bg-white dark:bg-[#1a1a1a] text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-xs font-bold uppercase tracking-wider shadow-sm transition-all"
                                placeholder="Cari Dokumen, Toko, Sales...">
                        </div>
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <select wire:model.live="filter_cabang"
                            class="block w-full px-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl leading-5 bg-white dark:bg-[#1a1a1a] text-slate-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 text-xs font-bold uppercase tracking-wider shadow-sm cursor-pointer transition-all">
                ...
                <table class="w-full text-sm text-left uppercase whitespace-nowrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-6 py-5">Tgl Pelunasan</th>
                            ...
                            <th class="px-6 py-5 text-right">Nominal Diterima (Rp)</th>
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button wire:click="delete({{ $item->id }})"
                                        wire:confirm="HAPUS PERMANEN: Yakin menghapus data pelunasan {{ $item->sing_no }}?"
                                ...
                                <span
                                    class="text-[9px] font-black text-slate-400 border border-slate-200 dark:border-white/10 px-2 py-1 rounded-md bg-slate-50 dark:bg-white/5 cursor-not-allowed"><i
                                        class="fas fa-lock text-rose-400 mr-1"></i> Terkunci</span>
                                @endif
                            </td>
                        </tr>
                        @empty
                            ...
                            <td colspan="7" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p
                                        ...
                                        Tidak ada data pelunasan yang sesuai.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
            ...
            <div
                ...
                <div class="w-full sm:w-auto overflow-hidden">{{ $collection->links() }}</div>
                <div class="text-[10px] font-black uppercase tracking-widest text-slate-400">Total:
                    {{ $collection->total() }} Baris</div>
            </div>
        </div>
    </div>
            ...
            <div
                ...
                <div>
                    <h3
                        ...
                        {{ $isEdit ? 'Edit Data Pelunasan' : 'Input Pelunasan Manual' }}
                    </h3>
                ...
                <form wire:submit.prevent="store" class="space-y-6 font-jakarta text-xs uppercase">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            <label
                                ...
                                Dokumen Pelunasan <span class="text-rose-500">*</span></label>
                            <div class="relative"><i
                                    class="fas fa-file-invoice absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i><input
                                    type="text" wire:model="sing_no"
                                    class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 pl-10 pr-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all shadow-sm"
                                    placeholder="COL-2026..."></div>
                            @error('sing_no') <span
                        ...
                        <div>
                            <label
                                ...
                                Pelunasan <span class="text-rose-500">*</span></label>
                            <input type="date" wire:model="tanggal"
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all shadow-sm">
                            @error('tanggal') <span
                                class="text-[10px] text-rose-500 font-bold mt-1.5 block">{{ $message }}</span> @enderror
                        </div>
                    </div>
                    <div
                        ...
                        <div>
                            ...
                            <select wire:model="cabang"
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#121212] px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all shadow-sm">
                    ...
                    <div
                        ...
                        <label
                            ...
                            Kas Diterima (Rp) <span class="text-rose-500">*</span></label>
                        <div class="relative flex items-center">
                            <span
                                class="absolute left-4 font-black text-emerald-600 dark:text-emerald-400 text-sm">Rp</span>
                            <input type="number" wire:model="receive_amount"
                    ...
                    <div class="pt-8 flex items-center justify-end gap-3">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-white bg-emerald-600 hover:bg-emerald-700 active:scale-95 transition-all shadow-xl shadow-emerald-500/30 flex items-center gap-2">
