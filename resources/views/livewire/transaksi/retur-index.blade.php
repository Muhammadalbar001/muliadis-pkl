        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <button wire:click="create"
                    class="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl flex items-center gap-2 shadow-lg shadow-rose-500/30 transition-transform active:scale-95 font-black text-[10px] uppercase tracking-widest">
    ...
    <div class="px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    <div class="md:col-span-4">
                        ...
                        <div class="relative">
                            ...
                            <input wire:model.live.debounce.500ms="search" type="text"
                                class="block w-full pl-11 pr-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl leading-5 bg-white dark:bg-[#1a1a1a] text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-xs font-bold uppercase tracking-wider shadow-sm transition-all"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select wire:model.live="filter_cabang"
                            class="block w-full px-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl leading-5 bg-white dark:bg-[#1a1a1a] text-slate-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 text-xs font-bold uppercase tracking-wider shadow-sm cursor-pointer transition-all">
                ...
                <table class="w-full text-sm text-left uppercase whitespace-nowrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-6 py-5">Tgl Retur</th>
                            <th class="px-6 py-5">No Dokumen Retur</th>
                            <th class="px-6 py-5">Cabang</th>
                            <th class="px-6 py-5">Salesman</th>
                            <th class="px-6 py-5">Toko / Pelanggan</th>
                            <th class="px-6 py-5 text-right">Nilai Retur (Rp)</th>
                            <th class="px-6 py-5 text-center">Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                        @forelse($retur as $item)
                        <tr class="hover:bg-rose-50 dark:hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="px-6 py-4 text-center">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <button wire:click="delete({{ $item->id }})"
                                        wire:confirm="HAPUS PERMANEN: Yakin ingin menghapus data retur {{ $item->no_retur }}?"
                            ...
                            <td colspan="7" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p
                                        ...
                                        Tidak ada data retur yang sesuai.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
            ...
            <div
                ...
                <div class="w-full sm:w-auto overflow-hidden">{{ $retur->links() }}</div>
                <div class="text-[10px] font-black uppercase tracking-widest text-slate-400">Total:
                    {{ $retur->total() }} Baris</div>
            </div>
        </div>
    </div>
            ...
            <div
                ...
                <div>
                    <h3
                        ...
                        {{ $isEdit ? 'Edit Data Retur' : 'Input Retur Manual' }}
                    </h3>
                ...
                <form wire:submit.prevent="store" class="space-y-6 font-jakarta text-xs uppercase">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            <label
                                ...
                                Dokumen Retur <span class="text-rose-500">*</span></label>
                            <div class="relative"><i
                                    class="fas fa-file-invoice absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i><input
                                    type="text" wire:model="no_retur"
                                    class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 pl-10 pr-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-all shadow-sm"
                                    placeholder="RTR-2026..."></div>
                            @error('no_retur') <span class="text-[10px] text-rose-500 font-bold mt-1.5 block"><i
                        ...
                        <div>
                            <label
                                ...
                                Retur <span class="text-rose-500">*</span></label>
                            <input type="date" wire:model="tgl_retur"
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-all shadow-sm">
                            @error('tgl_retur') <span class="text-[10px] text-rose-500 font-bold mt-1.5 block"><i
                                    class="fas fa-info-circle mr-1"></i>{{ $message }}</span> @enderror
                        </div>
                    </div>
                    <div
                        ...
                        <div>
                            ...
                            <select wire:model="cabang"
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#121212] px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-all shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="relative"><i
                                    ...
                                    class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#121212] pl-10 pr-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-rose-500 transition-all shadow-sm"
                    ...
                    <div>
                        ...
                        <div class="relative"><i
                                ...
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 pl-10 pr-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-rose-500 transition-all shadow-sm"
                    ...
                    <div
                        ...
                        <label
                            class="block text-[10px] font-black text-rose-700 dark:text-rose-400 mb-2 tracking-widest">Total
                            Nilai Retur (Rp) <span class="text-rose-500">*</span></label>
                        <div class="relative flex items-center">
                            <span class="absolute left-4 font-black text-rose-600 dark:text-rose-400 text-sm">Rp</span>
                            <input type="number" wire:model="total_grand"
                                class="w-full rounded-xl border border-rose-200 dark:border-rose-500/30 bg-white dark:bg-black/40 pl-12 pr-4 py-4 font-black text-rose-700 dark:text-rose-300 focus:ring-2 focus:ring-rose-500 focus:border-rose-500 text-lg shadow-sm transition-all"
                                placeholder="0">
                        </div>
                        @error('total_grand') <span
                            class="text-[10px] text-rose-500 font-bold mt-1.5 block">{{ $message }}</span> @enderror
                    </div>
                    <div class="pt-8 flex items-center justify-end gap-3">
                        ...
                        <button type="submit" wire:loading.attr="disabled"
                            class="px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-white bg-rose-600 hover:bg-rose-700 active:scale-95 transition-all shadow-xl shadow-rose-500/30 flex items-center gap-2">
