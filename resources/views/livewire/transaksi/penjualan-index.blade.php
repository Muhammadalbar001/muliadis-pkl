<div class="min-h-screen pb-20 font-jakarta bg-slate-50 dark:bg-[#050505] transition-colors duration-300">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <button wire:click="create"
                    class="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl flex items-center gap-2 shadow-lg shadow-blue-500/30 transition-transform active:scale-95 font-black text-[10px] uppercase tracking-widest"><i
            ...
            <div class="p-6 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/[0.02]">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                    <div class="md:col-span-4"><label
                            class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5">Pencarian</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"><i
                                ...
                                class="block w-full pl-11 pr-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl leading-5 bg-white dark:bg-[#1a1a1a] text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 text-xs font-bold uppercase shadow-sm transition-all"
                    ...
                    <div class="md:col-span-2"><label
                            ...
                            class="block w-full px-4 py-3 border border-slate-200 dark:border-white/10 rounded-2xl bg-white dark:bg-[#1a1a1a] text-slate-700 dark:text-white focus:ring-2 focus:ring-blue-500 text-xs font-bold uppercase shadow-sm transition-all">
                    ...
                    <div class="md:col-span-2"><label
                            class="block text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-1.5">Mulai
                    ...
                    <div class="md:col-span-2"><button wire:click="resetFilters"
                            class="w-full px-4 py-3 border border-rose-200 dark:border-rose-500/30 text-rose-500 bg-rose-50 dark:bg-rose-500/10 hover:bg-rose-100 rounded-2xl font-black text-[10px] uppercase shadow-sm">Reset</button>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full text-sm text-left uppercase whitespace-nowrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-6 py-5 text-right">Grand Total (Rp)</th>
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                        ...
                        <tr class="hover:bg-blue-50 dark:hover:bg-white/[0.02] transition-colors">
                            ...
                            <td class="px-6 py-4 text-xs font-black text-blue-600 dark:text-blue-400">
                                {{ $item->trans_no ?? $item->no_penjualan }}</td>
                ...
                <form wire:submit.prevent="store" class="space-y-6 font-jakarta text-xs uppercase">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div><label
                                ...
                                Dokumen <span class="text-rose-500">*</span></label><input type="text"
                                wire:model="no_dokumen"
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
                                required></div>
                        <div><label
                                ...
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
                                required></div>
                    </div>
                    <div
                        ...
                        <div><label
                                ...
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#121212] px-4 py-3.5 font-bold dark:text-white cursor-pointer focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
                                required>
                        ...
                        <div><label
                                ...
                                <span class="text-rose-500">*</span></label><input type="text" wire:model="sales_name"
                                class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#121212] px-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
                                required></div>
                    </div>
                    <div><label
                            class="block text-[10px] font-black text-slate-500 dark:text-slate-400 mb-2 tracking-widest">Nama
                            Toko / Pelanggan <span class="text-rose-500">*</span></label><input type="text"
                            wire:model="nama_pelanggan"
                            class="w-full rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-black/40 px-4 py-3.5 font-bold dark:text-white focus:ring-2 focus:ring-blue-500 transition-all shadow-sm"
                            required></div>
                    <div
                        class="bg-blue-50 dark:bg-blue-500/10 p-6 rounded-2xl border border-blue-100 dark:border-blue-500/20">
                        <label
                            class="block text-[10px] font-black text-blue-700 dark:text-blue-400 mb-2 tracking-widest">Nominal
                            (Rp) <span class="text-rose-500">*</span></label><input type="number" wire:model="nominal"
                            class="w-full rounded-xl border border-blue-200 dark:border-blue-500/30 bg-white dark:bg-black/40 px-4 py-4 font-black text-blue-700 dark:text-blue-300 focus:ring-2 focus:ring-blue-500 text-lg shadow-sm transition-all"
                            required>
                    </div>
                    <div class="pt-8 flex items-center justify-end gap-3"><button type="submit"
                            class="px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-white bg-blue-600 hover:bg-blue-700 shadow-xl shadow-blue-500/30">Simpan
                            Record</button></div>
                </form>
            </div>
        </div>
    ...
    <div
        ...
        <div
            ...
            <div
                class="bg-emerald-50 dark:bg-emerald-900/20 px-8 py-6 border-b border-emerald-100 dark:border-emerald-800/30 flex items-center justify-between shrink-0">
                <div>
                    <h3
                        class="text-base font-black uppercase tracking-widest text-emerald-800 dark:text-emerald-400 flex items-center gap-3">
                        <div
                            class="w-8 h-8 rounded-lg bg-emerald-200 dark:bg-emerald-500/30 text-emerald-700 dark:text-emerald-300 flex items-center justify-center">
                            <i class="fas fa-file-excel text-sm"></i></div>Impor Data Massal
                    </h3>
                </div>
                <button wire:click="$set('showModalImport', false)"
                    class="text-emerald-600 hover:text-emerald-800 dark:text-emerald-400 dark:hover:text-white transition-colors bg-white dark:bg-white/5 border border-emerald-200 dark:border-white/10 rounded-full w-10 h-10 flex items-center justify-center shadow-sm"><i
                        class="fas fa-times"></i></button>
            </div>
            <div class="p-8">
                <form wire:submit.prevent="importData" class="space-y-6 font-jakarta text-xs uppercase">
                    ...
                    @if($file_excel) <div
                        class="w-full p-4 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 text-emerald-700 dark:text-emerald-400 font-bold text-[10px] tracking-widest flex items-center justify-between">
                    ...
                    <div class="pt-6 flex items-center justify-end gap-3 border-t border-slate-100 dark:border-white/5">
                        <button type="submit" wire:loading.attr="disabled"
                            class="px-8 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-white bg-emerald-600 hover:bg-emerald-700 active:scale-95 transition-all shadow-xl shadow-emerald-500/30 flex items-center gap-2 disabled:opacity-50"><span
