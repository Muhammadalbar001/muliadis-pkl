        ...
        <div wire:loading.class="opacity-50 pointer-events-none"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div
                    ...
                    <div>
                        <p class="text-[10px] font-black uppercase tracking-widest text-rose-500">Piutang Macet (>30
                            Hari)
                        </p>
                    ...
                    <table class="w-full text-xs text-left border-collapse uppercase">
                        <thead>
                            <tr
                                ...
                                <th class="px-6 py-5 border-r dark:border-white/5 border-slate-100 text-center">Umur
                                </th>
                                <th
