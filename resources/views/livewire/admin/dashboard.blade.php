                    ...
                    <div
                        ...
                        <div class="relative z-10 text-white">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <p class="text-[10px] font-black uppercase tracking-widest opacity-80">Total Penjualan
                                </p>
                            </div>
                            ...
                            <div class="mt-4 flex items-center gap-2">
                                ...
                                <p class="text-[10px] font-mono opacity-60">{{ number_format($salesSum, 0, ',', '.') }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="relative z-10 text-white">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <p class="text-[10px] font-black uppercase tracking-widest opacity-80">Toko Aktif (OA)
                                </p>
                            </div>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h4
                                ...
                                <span class="w-2 h-2 rounded-full bg-blue-500 animate-pulse"></span> Tren Penjualan
                                Harian
                            </h4>
                            <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <h4
                                ...
                                <span class="w-2 h-2 rounded-full bg-orange-500 animate-pulse"></span> Tagihan vs
                                Pelunasan
                            </h4>
                            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    ...
                    <div
                        ...
                        <div class="w-full bg-black/20 h-1.5 rounded-full mt-3 overflow-hidden">
                            <div class="bg-white h-full rounded-full" style="width: {{ min($globalPersen, 100) }}%">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="w-full text-left text-xs">
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors group">
                                    ...
                                    <td
                                        class="px-6 py-4 text-right font-mono font-black text-slate-800 dark:text-white">
                                    ...
                                    <td class="px-6 py-4 text-right font-mono text-[10px]">
                                        ...
                                        @else <span
                                            class="text-red-500">{{ number_format($s['gap'], 0, ',', '.') }}</span>
                                        @endif
                                    </td>
