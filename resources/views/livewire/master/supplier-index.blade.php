<div class="min-h-screen space-y-6 pb-10 transition-colors duration-300 font-jakarta" x-data="{ filterOpen: false }">
    ...
    <div class="sticky top-0 z-40 backdrop-blur-xl border-b transition-all duration-300 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-4 mb-6
        ...
        <div class="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div class="flex flex-wrap lg:flex-nowrap items-center gap-3 w-full lg:w-auto justify-end">

                <div class="relative min-w-[200px] lg:w-64 group">
                    <i
                ...
                <div class="relative w-fit" x-data="{ open: false, selected: @entangle('filterKategori').live }">
                ...
                <div class="relative w-fit" x-data="{ open: false, selected: @entangle('filterCabang').live }">
                    <button @click="open = !open" @click.outside="open = false"
                        class="flex items-center gap-3 border-2 px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-sm
                        dark:bg-black/40 dark:text-slate-200 bg-white border-slate-200 text-slate-800 hover:border-cyan-500 whitespace-nowrap">
                ...
                <div class="w-36 shrink-0">
                    <div class="relative">
                        <select wire:model.live="filterStatus"
                            class="w-full border-2 px-4 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest shadow-sm dark:bg-black/40 dark:text-slate-200 bg-white border-slate-200 text-slate-800 focus:border-cyan-500 outline-none appearance-none transition-all">
                            <option value="">Semua Status</option>
                            <option value="1">Aktif</option>
                            <option value="0">Non-Aktif</option>
                        </select>
                        <i
                            class="fas fa-chevron-down absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none opacity-40 text-[8px]"></i>
                    </div>
                </div>

                <div class="flex items-center gap-2 shrink-0 ml-2">
                    <button wire:click="syncFromProducts"
                        class="p-2.5 dark:bg-white/5 bg-slate-800 border-2 dark:border-white/10 border-slate-700 text-white rounded-xl hover:bg-cyan-600 transition-all shadow-md"
                        title="Sync Data">
                    ...
                    <tbody class="divide-y-2 dark:divide-white/5 divide-slate-200">
                        ...
                        <tr>
                            <td colspan="9" class="px-6 py-32 text-center opacity-30"><i
                                ...
                                <p class="text-sm font-black tracking-[0.3em] uppercase text-slate-500">Database Kosong
                                </p>
                            </td>
                        </tr>
                        @endforelse
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-10">
            ...
            <div
                ...
                <div
                    ...
                    <div class="absolute -right-4 -bottom-4 opacity-10 rotate-12"><i class="fas fa-truck text-8xl"></i>
                    </div>
                ...
                <div class="p-10 space-y-6 font-jakarta">
                    <div class="grid grid-cols-2 gap-6">
                        <div class="group"><label
                                class="block text-[11px] font-black text-slate-600 dark:text-slate-400 uppercase tracking-widest mb-2.5 ml-1">Cabang</label><input
                                type="text" wire:model="cabang"
