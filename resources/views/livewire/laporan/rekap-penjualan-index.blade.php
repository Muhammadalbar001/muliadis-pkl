            ...
            <div class="flex items-center gap-4 w-full xl:w-auto">
                ...
                <div>
                    ...
                    <p
                        ...
                        Audit Penjualan Menyeluruh ({{ number_format($penjualans->total(), 0, ',', '.') }} Baris)</p>
                </div>
            </div>
                ...
                <table class="text-[10px] text-left border-collapse whitespace-nowrap min-w-max w-full uppercase">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">Harga Satuan
                            </th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right italic">
                                Rata-Rata</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">D1 %</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">D2 %</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">Disc 1</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">Disc 2</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">Disc Bawah
                            </th>
                            <th
                                class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right text-rose-600 dark:text-rose-400 font-black">
                                Total Diskon</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right font-bold">
                                Jual Bersih</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right font-bold">
                                Total Kotor</th>
                            ...
                            <th
                                ...
                                Kode Sales</th>
                            <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 font-bold">Nama Salesman
                            </th>
                            <th
                    ...
                    <tbody class="divide-y dark:divide-white/10 divide-slate-300">
                        ...
                        <tr
                            ...
                            <td class="px-4 py-3 border-r dark:border-white/10 border-slate-200 font-mono opacity-50">
                                {{ $item->kode_item }}</td>
                            <td class="px-4 py-3 border-r dark:border-white/10 border-slate-200 font-mono font-bold">
                                {{ $item->sku }}</td>
                            ...
                            <td class="px-4 py-3 border-r dark:border-white/10 border-slate-200 text-right opacity-50">
                            ...
                            <td class="px-4 py-3 border-r dark:border-white/10 border-slate-200 text-right font-bold">
                            ...
                            <td class="px-4 py-3 border-r dark:border-white/10 border-slate-200">{{ $item->pembayaran }}
                            </td>
                            <td
                            ...
                            <td
                                ...
                                {{ $item->supplier }}</td>
                            <td class="px-4 py-3 border-r dark:border-white/10 border-slate-200 text-center opacity-40">
                                {{ $item->divisi }}</td>
