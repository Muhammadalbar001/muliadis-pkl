                    ...
                    <table
                        ...
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 italic">Informasi
                                </th>
                                <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">Total
                                    Nilai
                                </th>
                                <th
                                ...
                                <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">Berjalan
                                    (Current)</th>
                                <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">1-15
                                    Hari
                                </th>
                                <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-right">16-30
                                    Hari
                                </th>
                                <th
                                    ...
                                    > 30 Hari</th>
                                <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 text-center">Status
                                </th>
                                <th class="px-4 py-6 border-r dark:border-white/10 border-slate-300 min-w-[200px]">
                                    Alamat
                                    Pengiriman</th>
                        ...
                        <tbody class="divide-y dark:divide-white/10 divide-slate-300">
                            ...
                            <tr
                                ...
                                <td
                                    class="px-4 py-3 border-r dark:border-white/10 border-slate-200 font-bold opacity-80">
                                    {{ $item->sales_name }}</td>
                                <td
                                ...
                                <td
                                    ...
                                    {{ $item->jatuh_tempo }}</td>
                                <td
                                    class="px-4 py-3 border-r dark:border-white/10 border-slate-200 text-right opacity-60">
